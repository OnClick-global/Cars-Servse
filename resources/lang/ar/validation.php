...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'Adress_ar' => 'العنوان بالعربيه',
        'Adress_en' => 'العنوان بالاندليزيه',
        'about_ar' => 'ماذا عننا بالعربيه',
        'about_en' => 'ماذا عننا بالانجليزيه',
        'phone1' => 'رقم الهاتف الاول',
        'phone2' => 'رفم الهاتف الثاني',
        'Email' => 'البريد الالكتروني',
        'Whatsapp' => 'رقم الواتس اب',
        'facebook' => 'صفحه الفيس بوك',
        'twitter' => 'صفحه تويتر',
        'des_ar' => 'الوصف بالعربيه',
        'des_en' => 'الوصف بالانجليزيه',
        'status' => 'الحاله',
        'image' => 'الصوره',
