        ...
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(assets/media/bg/bg-1.jpg);">
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                ...
                <div class="d-flex flex-center mb-15">
                    <a href="#">
                        <img src="assets/media/logos/onclick.png" class="max-h-100px" alt="" />
                    </a>
                </div>
                <!--end::Login Header-->
                <!--begin::Login Sign in form-->
                <div class="login-signin">
                    <form class="form" id="" method="POST" action="<?php echo e(route('login')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5  <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"   type="text" placeholder="Email" name="email" autocomplete="off" />
                        </div>
...
<?php /**PATH C:\xampp\htdocs\dashboard\Lara8\resources\views/auth/login.blade.php ENDPATH**/ ?>